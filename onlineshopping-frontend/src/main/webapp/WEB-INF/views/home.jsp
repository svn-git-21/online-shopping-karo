					...
					<div id="carousel-example-generic" class="carousel slide"
						...
						<div class="carousel-inner">
							<div class="item active">
								<img class="slide-image" src="${images}/laptop.jpg" width="100" height="50"
									alt="">
							</div>
							<div class="item">
								<img class="slide-image" src="${images}/Phone.jpg" width="100" height="50"
									alt="">
							</div>
							<div class="item">
								<img class="slide-image"  src="${images}/TV.PNG" width="100" height="100"
									alt="">
							</div>
						</div>
